...
namespace EditorTexto
{
    public partial class Form1 : Form
    {
        ...
        private void mArquivoAbrir_Click(object sender, EventArgs e)
        {
            ...
            dialog.Title = "Abrir ...";
            dialog.Filter = "richt text file | *.rft | text | *.txt | todos | *.*";
        ...
        private void EscolherLocalSalvarArquivo()
        {
        ...
        private void mExibirZoomAmpliar_Click(object sender, EventArgs e)
        {
            ...
            AtualizarLabelZoom(txtConteudo.ZoomFactor);
        }
        ...
        private void AtualizarLabelZoom(float zoom)
        {
